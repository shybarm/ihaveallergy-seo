        ...
        <section className="bg-gradient-to-br from-stone-50 to-amber-50 border-b border-stone-200 py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              שומשום הוא אחד האלרגנים הנפוצים ביותר בישראל ובמזרח התיכון — עם סיכון משמעותי לאנפילקסיס. בשל השימוש הנרחב בטחינה וחומוס, הנסתר של שומשום במזון ישראלי הוא אחד המסובכים לניהול.
            </p>
