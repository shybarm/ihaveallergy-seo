...
const DESCRIPTION =
  "מחפשים אלרגולוג בחדרה? ד״ר אנה ברמלי, מומחית לאלרגיה בילדים ומבוגרים. מרפאה בהוד השרון, כ-30 דקות מחדרה. קביעת תור: 052-591-6393";
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-gray-600">כביש 2 דרומה → יציאת הוד השרון → הוד השרון. כ-30 דקות ללא פקק.</p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2"><MapPin className="w-4 h-4 text-teal-600 mt-0.5" /><div><div className="font-medium">כתובת</div><div className="text-gray-600">הוד השרון</div></div></div>
                <div className="flex items-start gap-2"><Phone className="w-4 h-4 text-teal-600 mt-0.5" /><div><div className="font-medium">טלפון</div><a href="tel:+972525916393" className="text-teal-600">052-591-6393</a></div></div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: "האם יש חנייה ליד המרפאה?", a: "כן, חנייה חינמית זמינה ליד המרפאה בהוד השרון." },
