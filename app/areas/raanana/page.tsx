      ...
      <main dir="rtl" lang="he" className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 mb-8">
            ...
            <p className="text-sm text-gray-700">כביש 4 דרומה יציאת הוד השרון, או דרך כביש 444 עד הוד השרון → הוד השרון. כ-15 דקות ללא פקק.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2"><MapPin className="w-4 h-4 text-orange-600 mt-0.5" /><div><div className="font-medium">כתובת</div><div className="text-gray-600">הוד השרון</div></div></div>
                <div className="flex items-start gap-2"><Phone className="w-4 h-4 text-orange-600 mt-0.5" /><div><div className="font-medium">טלפון</div><a href="tel:+972525916393" className="text-orange-600">052-591-6393</a></div></div>
